            ...
            <ul className="flex space-x-8">
              <li>
                <a
                  ...
                  className={`hover:text-emerald-500 transition-colors cursor-pointer ${
                    activeTab === "results" ? "text-emerald-500 font-bold" : ""
                  }`}
              ...
              <li>
                <a
                  href="#services"
                  className={`hover:text-emerald-500 transition-colors cursor-pointer ${
                    activeTab === "services" ? "text-emerald-500 font-bold" : ""
                  }`}
              ...
              <li>
                <a
                  href="#contact"
                  className={`hover:text-emerald-500 transition-colors cursor-pointer ${
                    activeTab === "contact" ? "text-emerald-500 font-bold" : ""
                  }`}
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 text-left mb-10 md:mb-0 md:pr-12">
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  <div className="text-4xl font-bold text-emerald-500">50+</div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl max-w-3xl">
              <div className="flex items-start mb-6">
                ...
                <p className="text-lg text-gray-700 italic">
                  ...
                  focus on both design and performance made all the difference."
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 animate-slide-in-up">
              ...
              <p className="text-gray-600 mb-6">
                Custom-designed pages that capture attention and drive visitors
                to take action.
              </p>
          ...
          <div className="hidden md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-700 mb-6">
                ...
                attention to both design and performance metrics delivered real
                business results."
              </p>
              <div className="flex items-center">
                <img
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-lg">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Founder, MobileFirst</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Product launch landing page that increased conversion rates
                    by 85% and reduced bounce rate by 40%.
                  </p>
                  <a
                    href="#"
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    Health app landing page with 200% increase in app downloads
                    and 65% reduction in acquisition costs.
                  </p>
                  <a
                    href="#"
                    className="text-emerald-500 hover:text-emerald-600 font-medium flex items-center transition-colors"
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        We make decisions based on metrics and performance data,
                        not just aesthetics.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        We optimize for speed, conversions, and user experience
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">hello@vysible.com</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="w-12 h-12 rounded-lg bg-emerald-100 flex items-center justify-center mr-4 flex-shrink-0">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        123 Growth Street, San Francisco, CA 94103
                      </p>
                    </div>
                  </div>
                </div>
